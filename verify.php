...
<title>Verify Contact Us</title>

<link rel="icon" href="images/images/flavicon.ico">

<link rel="icon" href="images/images/flavicon.ico"><meta name="description" content="The Wheeling Area of Narcotics Anonymous is a service area of Narcotics Anonymous, NA, meetings in in Barnesville, Bridgeport, St. Clairsville, Steubenville, and Toronto, Ohio, and in New Martinsville, Payden City, and Wheeling, West Virginia, and is a member of the Tri-State Region of Narcotics Anonymous." />
...
<div class="container">
    <div class="header"><img src="/images/images/Web Banner.jpg" alt="Insert Logo Here" name="Insert_logo" width="100%" height="170px" id="Insert_logo" style="background-color: #8090AB; display:block;" /></a> 
    <!-- end .header --></div>
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="justForToday.html">Just for Today</a></li>
        ...
        <h4  style= "color: #fff;">The message is hope.<br /><br />The promise is freedom from active addiction.</h4>
...
<br /><br /><h3>Thank you, $Name, for your message, which is $words words long:</h3><br /><br />
...
echo "<p>Click <a href='/index.html'>here </a> to continue.</p>";
        ...
        $ContactEmail = "webchair@wheelingna.org";
